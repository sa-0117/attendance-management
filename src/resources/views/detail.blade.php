...
@section('content')
    <div class="attendance-list">
        <div class="attendance-list__inner">
            ...
            <form class="detail-form" action="{{ route('attendance.detail.edit', [$id]) }}">
                <div class="detail-form__group">
                    ...
                    <div class="detail-form__row">
                        ...
                        <div class="detail-form__data">
                            <input type="text" name="date" value="{{ old('date', \Carbon\Carbon::parse($attendance->work_date)->format('Y年')) }}" readonly />
                            <input type="text" name="date" value="{{ old('date', \Carbon\Carbon::parse($attendance->work_date)->format('n月j日')) }}" readonly />
                        </div>
                    </div>
                    <div class="detail-form__row">
